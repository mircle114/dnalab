...
public class TreePrinter 
{
    ...
    private BinarySearchTree<? extends Object> tree;  // the tree
     ...
     */
    public TreePrinter(BinarySearchTree<? extends Object> tree)
    {
        this.tree = tree;
    ...
    {       
        ...
        BinaryNode<? extends Object> thisLevelNodes[] = 
                (BinaryNode<? extends Object>[]) new BinaryNode[1];
    ...
    private void printData(int level, int offset, 
                           BinaryNode<? extends Object> levelNodes[])
    {
        printSpaces(offset);
        
        int k = POWERS_OF_2[level];
        for (int i = 0; i < k; i++) {
            BinaryNode<? extends Object> node = levelNodes[i];
     ...
     */
    private BinaryNode<? extends Object>[] nextLevel(int level, 
                                            BinaryNode<? extends Object> levelNodes[])
    {
        BinaryNode<? extends Object> nextLevel[] = 
                (BinaryNode<? extends Object>[]) new BinaryNode[POWERS_OF_2[level+1]];
